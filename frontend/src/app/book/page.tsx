         ...
         <div className="container mx-auto px-6 pt-32 pb-24 relative z-10 flex flex-col items-center text-center">
           <div className="space-y-12 max-w-7xl mx-auto">
             ...
             <div id="booking" className="pt-24 space-y-8">
                      ...
                      <div className="flex-1 space-y-6">
                         ...
                         <div className="space-y-4">
                            <div className="bg-primary/10 border border-primary/30 p-5 rounded-xl">
                               ...
                               <div className="text-white/40 text-xs uppercase font-bold tracking-widest opacity-60">(30 min)</div>
                            </div>
                            <div className="text-[10px] font-black text-white/20 uppercase tracking-[0.4em] pt-4 text-center">Calendly Integrated Window</div>
                         </div>
                      </div>
                      ...
                      <div className="lg:w-2/3 space-y-6">
                         ...
                         <div className="bg-[#0a0d12]/60 border border-white/5 p-4 rounded-2xl overflow-x-auto">
                            <table className="w-full min-w-[600px] text-left">
                               <tbody>
                                  <TimeRow day="Mon" time1="10:00 AM" time2="2:00 PM" time3="2:00 PM" time4="10:00 PM" />
                                  <TimeRow day="Tue" time1="10:00 AM" time2="2:00 PM" time3="2:00 PM" time4="10:00 PM" />
                               </tbody>
                            </table>
                            <div className="pt-4 flex justify-end">
                               <button className="bg-white text-black px-8 py-3 rounded-lg font-black text-xs uppercase tracking-widest hover:bg-primary transition-colors">Confirm Booking</button>
                            </div>
                         </div>
                      </div>
                   </div>
                ...
                <div className="flex flex-wrap justify-center gap-x-12 gap-y-6 text-xs font-black text-white/30 uppercase tracking-[0.4em] pt-8 pb-12">
...
function TimeRow({ day, time1, time2, time3, time4 }: { day: string, time1: string, time2: string, time3: string, time4: string }) {
  return (
    <tr className="border-b border-white/5 last:border-0 h-14">
       <td className="text-xs font-black text-white/80 uppercase tracking-widest pr-8">{day}</td>
       {[time1, time2, time3, time4].map((t, idx) => (
          <td key={idx} className="pr-4">
             <button className="px-4 py-2 border border-white/10 rounded-lg text-xs font-bold text-white uppercase tracking-widest hover:bg-white/5 hover:border-white/20 transition-all">
                {t}
             </button>
          </td>
       ))}
