  ...
  return (
    <div className="fixed bottom-6 right-6 z-50 animate-in fade-in slide-in-from-right-10 duration-1000">
      <div className="glass p-4 rounded-2xl border border-white/10 flex items-center gap-4 text-left hover:border-primary/50 transition-all hover:scale-105 shadow-2xl group max-w-[280px]">
        ...
        <div>
          <h4 className="text-xs font-black text-white group-hover:text-primary transition-colors">Joseph Grekoski, CVA</h4>
          <p className="text-[10px] text-white/50 font-bold uppercase tracking-wider">Founder & Principal</p>
