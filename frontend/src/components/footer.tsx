...
export function Footer() {
  return (
    <div className="w-full flex flex-col items-center space-y-12 py-16 relative z-10">
      ...
      {/* Mini Footer Links */}
      <div className="flex flex-wrap justify-center gap-x-8 gap-y-4 text-sm font-black text-white/60 uppercase tracking-widest border-t border-white/5 pt-8 w-full max-w-3xl px-4">
